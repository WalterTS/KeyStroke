 ...
 * @author Walter
 */
public class Before extends javax.swing.JFrame {
...
System.out.println("todo bien todo bien");
   ...
   try {
        ...
        Logger.getLogger(Before.class.getName()).log(Level.SEVERE, null, ex);
    }
...
cadena=cadena+Long.toString(Resultados[i])+",";
 ...
 m.Tercero(persona,NombreArchivo, cadena,Name,exist);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Before.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
